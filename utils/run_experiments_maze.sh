...
# Experiment 4
terminator -T "planner" -e "bash -c 'source /home/michbaum/Projects/optag_EH/devel/setup.bash && 
roslaunch active_3d_planning_app_reconstruction run_experiment_isaac_rovioli.launch output_folder:="/home/michbaum/Projects/optag_EH/data/drift_logs/maze_drift_evaluation_drift_aware_config/" planner_config:="planners/drift_aware_planner.yaml"'" &
sleep 7
terminator -T "rovioli" -e "bash -c 'source /home/michbaum/Projects/maplab/devel/setup.bash && 
roslaunch maplab_node optag-maplab-node-w-rovioli.launch; bash'" 
