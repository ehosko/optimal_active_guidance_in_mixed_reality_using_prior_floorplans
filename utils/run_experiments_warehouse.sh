...
roslaunch active_3d_planning_app_reconstruction run_experiment_isaac_rovioli.launch output_file:="warehouse_drift_evaluation_reconstruction_planner.csv" planner_config:="planners/reconstruction_planner.yaml"'" &
sleep 7
...
# Experiment 3
terminator -T "planner" -e "bash -c 'source /home/michbaum/Projects/optag/devel/setup.bash && 
roslaunch active_3d_planning_app_reconstruction run_experiment_isaac_rovioli.launch output_file:="warehouse_drift_evaluation_example_config.csv" planner_config:="planners/example_config.yaml"'" &
sleep 7
terminator -T "rovioli" -e "bash -c 'source /home/michbaum/Projects/maplab/devel/setup.bash && 
roslaunch maplab_node optag-maplab-node-w-rovioli.launch; bash'" &
